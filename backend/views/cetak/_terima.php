    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Cetak Surat Pemberitahuan Diterima</h3>
        ...
        <div class="box-body">
          <?php
			...
			$form = ActiveForm::begin([
					...
					//'action'=>Yii::$app->request->baseUrl.'/cetak/create',
				...
				'form' => $form,
				'model' => $model,
				'label' => 'Masukkan 3 digit akhir No Daftar',
				'attribute1' => 'awal',
				'widgetOptions1'=> [
					'pluginOptions'=>[
						'max' => 500,
			...
			echo Html::button(Icon::show('check', ['class' => 'fa-1x'], Icon::BSG).'Pilih Nomor', [
					'type'=>'submit', 
					'class'=>'btn btn-primary pull-right',
					'data-toggle'=>'tooltip',
					'title'=>'Pilih Nomor',
					]);
			//echo Html::a('Cetak Surat', 'cetakterimasemua', ['class' => 'btn btn-primary pull-right','name'=>'Pdf', 'target'=>'_blank']);
			ActiveForm::end();
			?>
          <?php
